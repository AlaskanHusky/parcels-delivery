 ...
 * с операциями CRUD для узла {@link PointEntity}
 */
@Controller
public class PointController {
     ...
     * и редактирования узла {@link PointEntity}.
     ...
     * или редактирования узла.
     * Заполняет поля посылки данными с формы.
     * Сохраняет посылку в базе данных.
     *
     * @param   pointEntity  объект класса {@link PointEntity}
    ...
    /**
     * Заполняет форму данными выбранного узла.
     * После редактирования данных обновляет поля узла
     * в базе данных.
     *
     * @param   pointId   id посылки {@link PointEntity#id}
     * @param   model     объект слоя Model в Spring MVC
     * @return            перенаправление на страницу со списком узлов
     */
